    ...
    return (
        <div className="bg-card dark:bg-card p-4 rounded-2xl hover:shadow-lg transition duration-300 group">
            ...
            <div className="space-y-1">
                <h3 className="font-bold text-stone-800 dark:text-stone-100 truncate">{name}</h3>
                <p className="text-xs text-stone-500 dark:text-stone-400">{source}</p>
            ...
            {quantity > 0 ? (
                <div className="flex items-center justify-between mt-4 bg-primary/20 rounded-lg p-1">
                    <button className="w-8 h-8 flex items-center justify-center rounded-md bg-white dark:bg-slate-800 text-stone-600 dark:text-stone-200 shadow-sm hover:bg-red-50 hover:text-red-500 transition">
                        <Minus className="h-4 w-4" />
                    </button>
                    <span className="font-bold text-stone-800 dark:text-white text-sm">{quantity}</span>
                ...
                <button className="w-full mt-4 py-2 bg-slate-100 dark:bg-slate-700 hover:bg-primary hover:text-white dark:hover:bg-primary dark:hover:text-stone-900 text-stone-600 dark:text-stone-300 rounded-lg transition-colors flex items-center justify-center gap-2 group-hover:shadow-md">
