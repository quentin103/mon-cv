    ...
    return (
        <section className="w-full max-w-7xl mx-auto px-4 md:px-6 py-12 md:py-20 relative z-10">
            ...
            >
                ...
                <h2 className="text-xl md:text-4xl font-bold tracking-tight text-white mb-2">{portfolioData.expertise.title}</h2>
            </motion.div>
            ...
            >
                {portfolioData.expertise.items.map((expertiseItem) => (
                    <motion.div key={expertiseItem.id} variants={item} className="p-4 rounded-2xl bg-white/2 border border-white/5 hover:bg-white/5 transition-colors group">
                        ...
                        <div className="flex flex-wrap gap-2">
                            {expertiseItem.skills.map((skill, kid) => (
                                <span key={kid} className="inline-flex items-center gap-1.5 text-[10px] md:text-xs font-mono px-2 py-1 rounded-md bg-white/5 border border-white/5 text-white hover:bg-white/10 transition-colors">
